          ...
          <>
            <div className="mb-8">
              ...
              <p className="mt-2 text-sm text-zinc-400">
                Select a GitHub repository to connect. Aegis.ai will set up webhooks automatically.
              </p>
            </div>
            ...
            {filteredRepos.length === 0 ? (
              <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-zinc-800 p-12 text-center bg-zinc-900/10">
                ...
                <p className="mt-1 text-sm text-zinc-500 max-w-xs">
                  Make sure you have authorized Aegis.ai to access your repositories or try a different filter.
                </p>
              </div>
            ) : (
